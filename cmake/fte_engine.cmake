...
set(FTE_ENGINE_CLIENT_SOURCES
	...
	$<$<AND:$<NOT:$<BOOL:${FTE_ENGINE_USE_SDL}>>,$<BOOL:${EMSCRIPTEN}>>:${FTE_ENGINE_WEB_DIR}/fs_web.c>
	$<$<AND:$<NOT:$<BOOL:${FTE_ENGINE_USE_SDL}>>,$<BOOL:${EMSCRIPTEN}>>:${FTE_ENGINE_WEB_DIR}/gl_vidweb.c>
	$<$<AND:$<NOT:$<BOOL:${FTE_ENGINE_USE_SDL}>>,$<BOOL:${EMSCRIPTEN}>>:${FTE_ENGINE_WEB_DIR}/sys_web.c>
)
...
if(FTE_ENGINE_CLIENT)
	...
	target_compile_definitions(fteqw
		PRIVATE
			...
			$<$<STREQUAL:${FTE_ENGINE_RENDERER},d3d9>:D3D9QUAKE>
			$<$<STREQUAL:${FTE_ENGINE_RENDERER},d3d11>:D3D9QUAKE>
			$<$<STREQUAL:${FTE_ENGINE_RENDERER},d3d11>:D3D11QUAKE>
